...
/**
 * Rota temporária para popular o banco de produção com dados de exemplo.
 * Remover após o uso — protegida apenas por SEED_SECRET.
 */
export async function POST(req: Request) {
  ...
  await prisma.event.create({
    data: {
      ...
      organizerId,
      ticketTypes: {
        create: [{ name: "1º Lote", priceCents: 35000, quantity: 200, position: 0 }],
      },
    },
  });
